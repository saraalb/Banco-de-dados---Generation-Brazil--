...
-- adicionando uma coluna na tabela personagens para referenciar a fk:
...
-- filtrando por nome com c
SELECT * FROM tb_personagens
 WHERE nome LIKE "%c%";
-- filtrando por poder de defesa
SELECT * FROM tb_personagens
...
-- inner join com filtro de classe
SELECT * 
FROM tb_personagens INNER JOIN tb_classes
